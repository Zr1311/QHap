...
"""
Read-based haplotype phasing using MindQuantum BSB for max-cut solving.
Drop-in replacement for BSB_get_haplotype_and_combine.py.
"""
...
from mindquantum_bsb import solve_maxcut_bsb, build_J_from_edges, compute_xi_from_sparse
...
def process_single_block(component_graph, init_haplotype_data, sparse_matrix,
    ...
    J, node_to_idx = build_J_from_edges(edges, nodes, negate=True)
    n_v = len(nodes)
...
# ────────────────── Haplotype reconstruction helpers (unchanged) ──────────────────
